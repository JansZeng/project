...
void Displayonebyte( const byte *pcDsSource, double addnum, double subnum, double mulnum, double divnum, const byte* pcFormat, byte *pcDataOut );
...
void DisTime(const uint8* pcDsSource,uint8 * pcFormula,uint8* pcDsValueOut);
